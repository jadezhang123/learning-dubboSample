...
package own.jadezhang.learning.dubboSample.dao.basic;
 ...
 */
@Repository
public interface IBasicBatchTaskDAO extends IBaseDAO<BasicBatchTask> {

    List<BasicBatchTask> queryTaskPage(@Param("condition") Map<String, Object> condition,
